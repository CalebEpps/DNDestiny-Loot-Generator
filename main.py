...
class UI:
    ...
    dbLoadingBar = PyQt5.QtWidgets.QProgressBar()
    textLabel = PyQt5.QtWidgets.QLabel("Loading Database...")
    ...
    def createInitialWindow(self):
        ...
        self.window.setWindowTitle("Destiny 2 Loot Generator")
        self.window.setFixedSize(500, 100)

        mainGrid = PyQt5.QtWidgets.QGridLayout()
        mainGrid.addWidget(self.dbLoadingBar)

        self.dbLoadingBar.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.textLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        mainGrid.addWidget(self.textLabel)
    ...
    def get_manifest(self):
        ...
        with open("MANZIP", "wb") as zip:
            ...
            for data in r.iter_content(block_Size):
                ...
                self.dbLoadingBar.setValue(int(self.dlProgress / manifest_Size))
                zip.write(data)
            progress_bar.close()
